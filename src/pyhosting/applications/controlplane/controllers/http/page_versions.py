...
from pyhosting.domain.errors import EmptyContentError
...
from .models.page_versions import CreatePageVersionResult
...
class PageVersionsRouter(APIRouter):
    def __init__(
        ...
        self.create_usecase = crud_versions.CreatePageVersion(
            ...
            clock=self.clock,
            get_page=crud_pages.GetPage(self.pages_repository),
            update_latest_version=crud_pages.UpdateLatestPageVersion(
